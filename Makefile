...
run: compile
	bash -c 'time ./fastpermt run --tmin 100 --tmax 200 --method maxt --tfce --graph-file aux/graph -c 30 --ignore-label aux/ft_ignore-lh.label $$(ls data/ | cut -f1,2 -d_ | uniq | xargs -I{} echo data/{}_90_control-lh.stc data/{}_90_kanizsa-lh.stc) -o aux/result.stc'
